...
<body>
    <div class="header">
        ...
        $base64 = file_exists($logoPath) ? 'data:image/' . pathinfo($logoPath, PATHINFO_EXTENSION) . ';base64,' .
        base64_encode(file_get_contents($logoPath)) : '';
        @endphp
        @if($base64)
        <img src="{{ $base64 }}" class="img-fluid" alt="Company Logo"
            style="width: 120px; position: absolute; top: 0; left: 0;">
        @endif
        ...
        <h5 style="margin-left:10px;">Cheque Receive Report</h5>
    </div>
    <table>
        <thead>
            <tr>
