        ...
        <div class="modal-content">
            ...
            <form action="" method="POST" id="editClientForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="form-label">Client Name <span class="required-label">*</span></label>
                        <input id="edit_client_name" type="text" class="form-control" name="client_name" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Client Designation</label>
                        <input id="edit_client_designation" type="text" class="form-control" name="client_designation">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Company Name</label>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            <a href="#" id="edit" class="btn btn-link btn-primary" data-bs-toggle="modal" data-bs-target="#updateClientModal"
                                               ...
                                               data-status="{{ $client->status }}" title="Edit">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <form action="{{ route('client.destroy', $client->id) }}" method="POST" style="display: inline-block;" onsubmit="event.preventDefault(); confirmDelete(this);">
                                                @csrf
                                                @method('DELETE')
    ...
    $('#editClientForm').on('submit', function (e) {
        ...
        $.ajax({
            ...
            error: function (xhr) {
                ...
                alert('An error occurred while updating the client. Please try again.'); // Optional user notification
            }
        });
    });
