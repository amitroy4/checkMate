            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title"> Manage Cheque Receives</h4>
                        <button class="btn btn-primary btn-round ms-auto" data-bs-toggle="modal" data-bs-target="#newChequeReceive">
                ...
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            <a href="#" class="btn btn-link btn-primary edit" data-bs-toggle="modal" data-bs-target="#updateClientModal"
                                            data-client-id="">
                 ...
                 <!-- Modal -->
                 <div class="modal fade" id="newChequeReceive" tabindex="-1" role="dialog" aria-hidden="true">
                            ...
                            <form action="" method="post">
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group ">
                                                <label for="receiveFrom">Receive From<span class="required-label">*</span></label>
                                                <select id="receiveFrom" class="form-control" name="receiveFrom">
